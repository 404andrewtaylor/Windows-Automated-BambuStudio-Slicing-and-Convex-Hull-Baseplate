...
def main():
    ...
    try:
        ...
        # Step 3.5: Apply 1mm buffer to convex hull
        print("[BUFFER] Step 3.5: Applying 1mm buffer to convex hull...")
        try:
            buffered_hull_points = offset_hull(hull_points, buffer_mm=1.0)
        ...
        print(f"[ANALYSIS] Buffer applied: 1.0mm")
