#!/usr/bin/env python3
"""
Launcher script for the Hull Baseplate Pipeline GUI Application.
...
def main():
    ...
    print("Hull Baseplate Pipeline - GUI Launcher")
    print("=" * 40)
    ...
    # Launch the GUI
    try:
        from hull_baseplate_gui import main as gui_main
        gui_main()
