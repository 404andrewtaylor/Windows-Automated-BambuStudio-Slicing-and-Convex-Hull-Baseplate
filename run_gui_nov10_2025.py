#!/usr/bin/env python3
"""
Launcher script for the Hull Baseplate Pipeline GUI Application (Nov 10, 2025 Version).
...
def main():
    ...
    print("Hull Baseplate Pipeline - GUI Launcher (Nov 10, 2025 - Simplified)")
    print("=" * 60)
    ...
    # Launch the GUI
    try:
        from hull_baseplate_gui_nov10_2025 import main as gui_main
        gui_main()
